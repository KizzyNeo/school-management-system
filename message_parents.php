...
<body>
    <div>
        <h1 style="color: rgb(20, 8, 53);">Message to Parents</h1>
    <form action="send_sms.php" method="post">
        ...
        <div style="margin-top: 10px;">
            ...
            <textarea name="recipients" id="Recipients" type="text" style="display: block; margin-top: 10px; outline: none; height: 300px; width: 300px; resize: none;" required>
            <?php
